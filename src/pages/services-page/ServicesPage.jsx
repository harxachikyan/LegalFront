...
const ServicesPage = () => {
    ...
    const serviceCategories = [
        ...
        },
        {
            ...
            color: "teal",
            services: [
                "Իրավաբանական անձանց հիմնադրում, վերակազմակերպում և լուծարում (ներառյալ օտարերկրյա իրավաբանական անձանց),",
        ...
        },
        {
            ...
            services: [
                ...
                "2.Հարկադրված սնանկության դիմումների կազմում,",
        ...
        },
        {
            ...
            color: "blue",
            services: [
                "Ներկայացուցչություն պետական գնումների հետ կապված վեճերով",
                "Ներկայացուցչություն մասնավոր գնումների հետ կապված վեճերով:"
            ]
        },
        {
